...
public class Banco3 {
    ...
    public static void main(String[] args) throws IOException {
     /*  El siguiente código comentado se uso para crear un par de cuentas e introducir movimientos en ellas 
       ...
       Cliente jesusCli = new Cliente("Jesús", "López", "Libertad", "Villamuriel", LocalDate.of(1986,10,12),false ); 
       jesusCli.calcular_edad();
       CuentaBancaria unaCuenta = new CuentaBancaria(654321l, jesusCli, 0.25f);
       ...
       System.out.println(jesusCli.nombreCompleto() + " tiene la cuenta: ");
       unaCuenta.verCuenta();
       Cliente otroCliente = new Cliente("Ana", "López", "Libertad", "Villamuriel", LocalDate.of(2001,10,12), true ); 
       CuentaBancaria otraCuenta = new CuentaBancaria(654322l, otroCliente, 0.25f);
       ...
       otraCuenta.verCuenta();
        ...
        System.out.println("operaciones totales "+CuentaBancaria.nOp);
        ...
        CuentaBancaria c; 
        try {   
            c = new CuentaBancaria(nc);// Constructor que lee del fichero los datos de la cuenta
        }
        catch(Exception e) {   
